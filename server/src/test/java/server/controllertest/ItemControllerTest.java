...
class ItemControllerTest {
    ...
    void addItem() throws Exception {
        Long ownerId = 1L;
        ItemDtoShort request = TestUtil.makeItemDtoShort(null, "банан", "он желтый", true, null);
        ItemDtoShort response = TestUtil.makeItemDtoShort(1L, "банан", "он желтый", true, null);
    ...
    void shouldReturn404WhenRequestNotFound() throws Exception {
        Long ownerId = 1L;
        ItemDtoShort request = TestUtil.makeItemDtoShort(null, "банан", "он желтый", true, 1L);
    ...
    void getItem() throws Exception {
        Long ownerId = 1L;
        Long itemId = 1L;
        ItemDto response = TestUtil.makeItemDto(1L, "банан", "желтый", true, null,
    ...
    void getOwnerItems() throws Exception {
        Long ownerId = 1L;
        ItemDto item1 = TestUtil.makeItemDto(1L, "банан", "желтый", true, null,
                new BookingShort(), new BookingShort(), Collections.emptyList());
        ItemDto item2 = TestUtil.makeItemDto(2L, "желудь", "красный", true, null,
                new BookingShort(), new BookingShort(), Collections.emptyList());
    ...
    void findItemsByName() throws Exception {
        Long ownerId = 1L;
        ItemDtoShort item1 = TestUtil.makeItemDtoShort(1L, "банан", "желтый", true, null);
        ItemDtoShort item2 = TestUtil.makeItemDtoShort(2L, "желудь", ",банановый мусс", true, null);
